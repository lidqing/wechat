...
//        menu.getButtons().add(button2);
    ...
    @GetMapping("/create2")
    public String menuCreateSample2() throws WxErrorException {
        WxMenu menu = new WxMenu();
        ...
        WxMenuButton button31 = new WxMenuButton();
        button31.setType(MenuButtonType.VIEW);
        button31.setName("政策法规");
        button31.setUrl("http://lidq.free.ngrok.cc/news/laws");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(MenuButtonType.VIEW);
        button32.setName("河长职责");
        button32.setUrl("http://lidq.free.ngrok.cc/news/duty");

        WxMenuButton button33 = new WxMenuButton();
        button33.setType(MenuButtonType.VIEW);
        button33.setName("河长动态");
        button33.setUrl("http://lidq.free.ngrok.cc/news/dynamic");
        //button33.setKey("开发中，敬请期待!");
        ...
        //菜单2
        WxMenuButton button1 = new WxMenuButton();
        button1.setName("社会监督");
        menu.getButtons().add(button1);

        WxMenuButton button11 = new WxMenuButton();
        button11.setType(MenuButtonType.CLICK);
        button11.setName("随手拍");
        //button11.setUrl("http://www.soso.com/");
        button11.setKey("开发中，敬请期待!");

        WxMenuButton button12 = new WxMenuButton();
        button12.setType(MenuButtonType.CLICK);
        button12.setName("投诉反馈");
        //button12.setUrl("http://www.soso.com/");
        button12.setKey("开发中，敬请期待!");
